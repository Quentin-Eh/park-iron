...
const LEGACY_EXERCISE_NAMES: Record<string, string> = {
  ...
  v3_dips: 'Ring Dips',
  v3_pullups: 'Pull-ups',
  v3_archer_pushups: 'Archer Push-ups',
  v3_pike_pushups: 'Pike Push-ups',
  v3_ring_curls: 'Ring Curls',
  v3_chinups: 'Chin-ups',
  v3_deep_pushups: 'Deep Push-ups',
  v3_pullups_ub: 'Pull-ups',
  v3_ring_rows: 'Ring Rows',
  v3_face_pulls: 'Ring Face Pulls',
  v3_pistols: 'Pistol Squats',
  v3_nordics: 'Nordic Curl Negatives',
  v3_jump_squats: 'Jump Squats',
  v3_leg_raises: 'Hanging Leg Raises',
  v3_bulgarians: 'Bulgarian Split Squats',
  v3_nordics_lb: 'Nordic Curl Negatives',
  v3_jump_squats_lb: 'Jump Squats',
  v3_vsit: 'V-sit Hold',
  v3_leg_raises_lb: 'Hanging Leg Raises',
  // v2 exercise IDs
